...
#'
#' `get_random_name` generates a random name from the list of adjectives
#' and surnames in this package formatted as `"adjective_surname"`. For
#' example `'focused_turing'`.
#' 
#' @export
get_random_name <- function () {
  paste(sample(LEFT, 1), sample(RIGHT, 1), sep = '_')
}
